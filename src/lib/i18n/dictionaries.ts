export const dictionaries = {
  en: {
    ...
    scanMap: {
      ...
      panDown: "Pan down",
      panRight: "Pan right",
      stormLocked: "🔒 Storm Feed — Apex only",
      stormError: "Couldn't load storm data — try again shortly.",
      stormClickToJump: "Click to jump the map here",
      stormDayRangeLabel: "Hail reports within:",
      stormDayCount: "{count}d",
      stormFeedTitle: "🌩 Storm Feed",
      stormFeedSubtitle: "Active warnings and significant hail hits — click one to jump there and scan.",
      stormFeedRefresh: "Refresh",
      stormFeedLoading: "Loading storm data…",
      stormFeedEmpty: "Nothing severe in range right now — check back during storm season.",
      stormFeedViewScan: "View & scan →",
      stormFeedActiveLabel: "Targeting: {label}",
      stormFeedClear: "Clear",
  ...
  es: {
    ...
    scanMap: {
      ...
      stormLocked: "🔒 Feed de tormentas — solo Apex",
      stormError: "No se pudieron cargar los datos de tormenta — intenta de nuevo en breve.",
      stormClickToJump: "Haz clic para llevar el mapa aquí",
      stormDayRangeLabel: "Reportes de granizo dentro de:",
      stormDayCount: "{count}d",
      stormFeedTitle: "🌩 Feed de tormentas",
      stormFeedSubtitle: "Alertas activas y granizo significativo reciente — haz clic para ir ahí y escanear.",
      stormFeedRefresh: "Actualizar",
      stormFeedLoading: "Cargando datos de tormenta…",
      stormFeedEmpty: "Nada severo en este rango ahora — vuelve a revisar durante la temporada de tormentas.",
      stormFeedViewScan: "Ver y escanear →",
      stormFeedActiveLabel: "Apuntando a: {label}",
      stormFeedClear: "Quitar",
